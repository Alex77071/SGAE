                ...
                <div class="faq-item">
                    ...
                    >
                        <p>
                            ...
                            Después elige la evidencia que deseas procesar
                ...
                <div class="faq-item">
                    ...
                    >
                        <p>
                            ...
                            tengas conexión con el sistema. Intenta nuevamente
                            y, si el problema persiste, utiliza
                ...
                <div class="faq-item">
                    ...
                    >
                        <p>
                            ...
                            de los exámenes realizados en Moodle. El sistema
                            descarga y organiza las imágenes disponibles para
                    ...
                    >
                        ...
                        >
                            <svg
                                ...
                                stroke-linejoin="round"
                            >
                                <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H11V5.5A2.5 2.5 0 0 0 8.5 3H4Z"></path>
                                <path d="M20 19.5A2.5 2.5 0 0 0 17.5 17H13V5.5A2.5 2.5 0 0 1 15.5 3H20Z"></path>
        ...
        pregunta.addEventListener('click', function () {
            ...
            document
                ...
                .forEach(function (otroItem) {
                    ...
                    const otraPregunta =
                        otroItem.querySelector('.faq-question');

                    const otraRespuesta =
                        otroItem.querySelector('.faq-answer');

                    const otroIcono =
                        otroItem.querySelector('.faq-icon');

                    otroItem.classList.remove('faq-item--active');
